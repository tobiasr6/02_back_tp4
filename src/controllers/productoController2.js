...
const getAllProductos = async (req, res) => {
    try {
        ...
        // Si hay un término de búsqueda, lo usamos para filtrar los resultados
        const searchCondition = search ? `WHERE p.Descripcion LIKE ?` : '';
        ...
        // Si hay un término de búsqueda, se añade el término con comodines
